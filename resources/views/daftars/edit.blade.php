     ...
     <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <select name="jenis_kelamin" id="jenis_kelamin" value="{{ $daftar->jenis_kelamin }}" class="form-control" required>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Kelas:</strong>
                <select class="form-control" name="kelas" id="kelas" value="{{ $daftar->kelas }}" required>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <select class="form-control" name="jurusan" id="jurusan" value="{{ $daftar->jurusan }}" required>
